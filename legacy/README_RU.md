...
Эти файлы были частью процесса миграции и ранней разработки. Они сохранены здесь для справки и чтобы
помочь разработчикам понять подход к миграции и эволюцию проекта.

Для текущей разработки используйте основной файл `docker-compose.yml` в корне проекта и стандартные
профили конфигурации Spring Boot.
