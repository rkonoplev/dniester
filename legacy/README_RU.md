...
Для текущей разработки используйте:
- Основной файл `docker-compose.yml` в корне проекта.
- Примеры API в `docs/API_REFERENCE.md`.
- Стандартные профили конфигурации Spring Boot.
