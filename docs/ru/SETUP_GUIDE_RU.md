...
-   **Docker**: Необходим для Testcontainers (интеграционные тесты) и опционально для локальной базы данных.
-   **Git**: Для клонирования репозитория проекта.

**Примечание**: Docker Compose опционален - нужен только если вы хотите запустить полный стек приложения локально. Интеграционные тесты используют Testcontainers и не требуют Docker Compose.
