...
6.  **Стратегия тестирования базы данных**
    ...
    - **Интеграционные тесты**: Используют Testcontainers с MySQL для соответствия продакшену
    - **CI среда**: MySQL через Docker Compose для реалистичного тестирования
...
7.  **Стратегия базы данных**
    ...
    - **Интеграция Testcontainers**: Реальные экземпляры MySQL для интеграционных тестов
