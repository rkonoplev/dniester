...
- [Что такое backend и frontend?](#что-такое-backend-и-frontend)
- [Самые частые команды (шпаргалка)](#самые-частые-команды-шпаргалка)
- [Как обновлять код в Docker?](#как-обновлять-код-в-docker)
- [Требования](#требования)
- [Альтернативный запуск (напрямую через Docker и Gradle)](#альтернативный-запуск-напрямую-через-docker-и-gradle)
  - [1. Запуск рабочего окружения](#1-запуск-рабочего-окружения)
  - [2. Проверка статуса](#2-проверка-статуса)
  - [3. Остановка окружения](#3-остановка-окружения)
...
- [Управление запущенным проектом](#управление-запущенным-проектом)
  - [Что происходит в терминале?](#что-происходит-в-терминале)
  - [Как выйти из терминала, не останавливая сервисы?](#как-выйти-из-терминала-не-останавливая-сервисы)
  - [Как начать и закончить рабочий день?](#как-начать-и-закончить-рабочий-день)
