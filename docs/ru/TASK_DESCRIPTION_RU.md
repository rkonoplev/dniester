...
- **Примечание**: Профессиональные команды могут создавать собственные frontend  
  используя headless API
...
- **Управление пользователями**: В памяти с настраиваемыми учетными данными  
  администратора
...
- ~~Отсутствие документации по миграции БД~~ → DATABASE_MIGRATION_GUIDE.md
...
6. **Профессиональный уровень**: Готовая к предприятию безопасность,  
