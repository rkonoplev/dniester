...
- ✅ **Все термины из Drupal 6 ИМЕЛИ словари** - они мигрируют корректно с исходными именами vocabulary
- ✅ **Имена словарей сохраняются**: "category", "tags", "topics" и т.д. из структуры Drupal 6
- ✅ **Связи терминов поддерживаются**: Все связи новости-термин сохраняются через `content_terms`
- ✅ **Никаких потерь данных**: Полная структура таксономии мигрирована с Drupal 6

**Два сценария базы данных:**
- **Миграция с Drupal 6**: Архивные термины сохраняют исходные классификации vocabulary
- **Чистая установка**: Новые термины создаются с гибкой группировкой vocabulary (напр., "category")
