...
- **[Руководство по установке](./SETUP_GUIDE_RU.md)**  
  Пошаговые инструкции по первоначальной настройке проекта, охватывающие все сценарии развертывания.

- **[Руководство разработчика](./DEVELOPER_GUIDE_RU.md)**  
  Ежедневный рабочий процесс для разработчиков, локальные команды, ожидания от CI/CD и устранение проблем.

- **[Руководство по API](./API_REFERENCE_RU.md)**  
  Исчерпывающее руководство с описанием эндпоинтов, `curl` примерами и спецификациями полей.

## 🏗️ Архитектура и настройка

- **[Принципы проектирования (SOLID, KISS)](./PRINCIPLES_RU.md)**  
  Описание фундаментальных принципов проектирования, применяемых в проекте.

- **[Паттерны проектирования](./DESIGN_PATTERNS_RU.md)**  
  Описание классических и архитектурных паттернов, используемых в проекте.
...
- **[Обзор конфигурационных файлов](../../backend/src/main/resources/README_RU.md)**  
  Подробное описание каждого файла `application-*.yml` и его роли в проекте.
...
- **[Руководство по фронтенд-фреймворкам](./FRONTEND_FRAMEWORKS_GUIDE_RU.md)**  
  Сравнительный обзор фронтенд-фреймворков, размеров зависимостей и лучших практик.
...
- **[Актуальное руководство по миграции](./MODERN_MIGRATION_GUIDE_RU.md)**  
  Современный, автоматизированный способ развертывания проекта с данными из дампа Drupal 6 с помощью Flyway.

- **[Историческое руководство по миграции](./MIGRATION_DRUPAL6_RU.md)**  
  Описание старого, ручного процесса миграции. Сохранено для исторической справки.
...
- **[Руководство по миграции вольюмов](./VOLUME_MIGRATION_GUIDE_RU.md)**  
  Безопасная миграция Docker volumes при переименовании контейнеров с phoebe-mysql на phoebe-mysql.
...
- **[Архивы миграции](./../../legacy/README_RU.md)**  
  Архив устаревших скриптов, конфигураций и дампов базы данных от первоначальной миграции с Drupal 6.
...
- **[Справочник команд Git и Bash](./GIT_BASH_COMMANDS_RU.md)**  
  Практические команды Git и Bash для разработки и устранения проблем.

- **[Сводка реализации улучшений CI/CD](./CI_CD_IMPROVEMENTS_RU.md)**  
  Подробная сводка реализованных оптимизаций CI/CD и рекомендаций для продакшена.

- **[Эволюция Testcontainers и стратегия](./TESTCONTAINERS_EVOLUTION_RU.md)**  
  Подробное руководство по использованию Testcontainers, эволюции и когда его реализовывать.

- **[Руководство по стратегии тестирования](./TESTING_STRATEGY_RU.md)**  
  Полный обзор архитектуры тестирования, включая гибридный подход интеграционного тестирования.
