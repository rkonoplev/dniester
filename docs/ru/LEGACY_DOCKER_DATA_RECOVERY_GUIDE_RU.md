...
> 
> **Для актуальных задач резервного копирования и переноса данных Docker, пожалуйста, обратитесь к:**
> - **[Руководству по переносу Docker Volume с данными MySQL](./VOLUME_MIGRATION_GUIDE_RU.md)**
...
# Историческое руководство по резервному копированию и восстановлению данных Docker (контекст миграции Drupal 6)

Этот документ описывает полный процесс инвентаризации, резервного копирования (дампа) и восстановления
всех баз данных проекта, хранящихся в Docker-вольюмах, в контексте миграции с Drupal 6.
